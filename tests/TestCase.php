...
class TestCase extends BaseTestCase
{
    ...
    public function createApplication()
    {
        ...
        $app->booting(function () {
            ...
            $loader->alias('Admin', \Hitechra\Admin\Facades\Admin::class);
        });

        $app->make('Illuminate\Contracts\Console\Kernel')->bootstrap();

        $app->register('Hitechra\Admin\AdminServiceProvider');
    ...
    protected function setUp(): void
    {
        ...
        $this->artisan('vendor:publish', ['--provider' => 'Hitechra\Admin\AdminServiceProvider']);
...
//        \Hitechra\Admin\Admin::$css = [];
//        \Hitechra\Admin\Admin::$js = [];
//        \Hitechra\Admin\Admin::$script = [];
    }
