...
`Hitechra\Admin\Widgets\Box` used to generate box components:
...
`Hitechra\Admin\Widgets\Collapse` class used to generate folding components:
```php
...
`Hitechra\Admin\Widgets\Form` class is used to quickly build a form:
...
`Hitechra\Admin\Widgets\InfoBox` class is used to generate the information presentation block:
...
`Hitechra\Admin\Widgets\Tab` class is used to generate the tab components:
...
`Hitechra\Admin\Widgets\Table` class is used to generate tables:
