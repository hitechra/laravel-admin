...
namespace Hitechra\Admin\Form;

use Hitechra\Admin\Admin;
use Hitechra\Admin\Form;
use Hitechra\Admin\Widgets\Form as WidgetForm;
...
class NestedForm
{
    ...
    /**
     * @var \Hitechra\Admin\Form|\Hitechra\Admin\Widgets\Form
     */
    protected $form;
    ...
    protected function prepareRecord($record)
    {
        ...
        foreach ($this->fields as $field) {
            ...
            if (($field instanceof \Hitechra\Admin\Form\Field\Hidden) || $value != $field->original()) {
                if (is_array($columns)) {
