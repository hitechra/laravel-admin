...
namespace Hitechra\Admin;

use Closure;
use Hitechra\Admin\Exception\Handler;
use Hitechra\Admin\Form\Builder;
use Hitechra\Admin\Form\Concerns\HandleCascadeFields;
use Hitechra\Admin\Form\Concerns\HasFields;
use Hitechra\Admin\Form\Concerns\HasHooks;
use Hitechra\Admin\Form\Field;
use Hitechra\Admin\Form\Layout\Layout;
use Hitechra\Admin\Form\Row;
use Hitechra\Admin\Form\Tab;
use Hitechra\Admin\Traits\ShouldSnakeAttributes;
...
class Form implements Renderable
{
     ...
     * @return $this
     */
    public function setView($view, $variables = []): self
    {
        $this->builder()->setView($view, $variables);
     ...
     * @param Closure $callback
     *
     * @return \Hitechra\Admin\Form\Footer
     */
